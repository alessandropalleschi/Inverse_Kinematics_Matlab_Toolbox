...
T = generateTrajectories(1,0.01,q0,robot.model,robot.tool,P,quat);

qout_RP = RP_inverse(T,0.001,q0,robot.model,robot.limits.position,robot.tool);

qout_CLIK = Standard_IK(T,0.001,q0,robot.model,robot.tool);
